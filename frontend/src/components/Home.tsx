  ...
  return (
    ...
    <div>
      ...
      <Container className="container" maxWidth="md">
        <h1 className="Thasadith" style={{ textAlign: "center" }}>ระบบแจ้งปัญหาการใช้งาน Software</h1>
      ...
      <TableContainer component={Paper}>
        <Table className="custom-table"  align="center"style={{ width: "70%", height: "300px" }}> {/* เพิ่มคลาส CSS */}
          <TableHead>
